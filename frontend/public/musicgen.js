...
export function chord_finder(key, chord_selection, chord_type_group, scale, notes, table_scheme) {
    ...
    try {
        ...
        const ret = wasm.chord_finder(ptr0, len0, chord_selection, ptr1, len1, ptr2, len2, notes, ptr3, len3);
        var ptr5 = ret[0];
        var len5 = ret[1];
        if (ret[3]) {
            ptr5 = 0; len5 = 0;
...
export function generate_midi(file_content, generation_mode, should_use_same_chords, num_chords, key, chord_selection, chord_type_group, chord_picking_method, min_number_of_unique_chords, scale, is_reproducible, pattern_to_use, duration) {
    ...
    const ptr6 = passStringToWasm0(pattern_to_use, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len6 = WASM_VECTOR_LEN;
    const ret = wasm.generate_midi(ptr0, len0, ptr1, len1, should_use_same_chords, num_chords, ptr2, len2, chord_selection, ptr3, len3, ptr4, len4, min_number_of_unique_chords, ptr5, len5, is_reproducible, ptr6, len6, duration);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
...
export function generate_midi_chord_progression(chords) {
    const ret = wasm.generate_midi_chord_progression(chords);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
...
export function get_chords_of_key(key, chord_selection, chord_type_group, scale, table_scheme, show_probabilities) {
    ...
    try {
        ...
        const ptr3 = passStringToWasm0(table_scheme, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ret = wasm.get_chords_of_key(ptr0, len0, chord_selection, ptr1, len1, ptr2, len2, ptr3, len3, show_probabilities);
        var ptr5 = ret[0];
        var len5 = ret[1];
        if (ret[3]) {
            ptr5 = 0; len5 = 0;
